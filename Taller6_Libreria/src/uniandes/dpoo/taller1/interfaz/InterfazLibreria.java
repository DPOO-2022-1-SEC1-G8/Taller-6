...
public class InterfazLibreria extends JFrame
{
	 ...
	 * se eliminaron.
	 * 
	 * Si no existe uno de los autores, entonces no se realiza la operaci�n y se le 
	 ...
	 * 
	 * Si el nuevo nombre de la categor�a es igual a aquel de otra categor�a no se
	 * realiza la operaci�n y se le informa al usuario.
	 */
	public void renombrarCategoria()
	{
		String nombreCategoria = JOptionPane.showInputDialog(this, "Escriba la categor�a que desea renombrar", "categor�a");
		if (nombreCategoria != null)
		{
			...
			if (posCategoria != -1)
			{
				String NuevoNombreCat = JOptionPane.showInputDialog(this, "Escriba el nuevo nombre de la categor�a", "nuevo nombre");
				if (NuevoNombreCat != null)
				{
					boolean cambio = libreria.renombrarCategoria(posCategoria, NuevoNombreCat);
					if (!cambio) 
					{
						JOptionPane.showMessageDialog(null,"Ya existe una categor�a con el mismo nombre.");
					}
					else 
					{
						panelCategorias.actualizarCategorias(libreria.darCategorias());
			...
			{
				JOptionPane.showMessageDialog(null,"La categor�a no existe.");
			}
		}
	}
